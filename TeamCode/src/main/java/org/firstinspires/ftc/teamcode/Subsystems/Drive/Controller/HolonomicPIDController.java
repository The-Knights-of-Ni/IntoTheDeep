 ...
 */
public class HolonomicPIDController implements HolonomicController {
    PID xControl;
    PID yControl;
    PID thetaControl;
     ...
     */
    public HolonomicPIDController(PID x, PID y, PID theta) {
     ...
     */
    @Override
    public HolonomicControllerOutput calculate(Pose current, Pose target) {
        ...
        return new HolonomicControllerOutput(xPower, yPower, thetaPower, current);
    }
